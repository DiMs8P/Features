...
AFeaturesCharacter::AFeaturesCharacter()
{
...
void AFeaturesCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AFeaturesCharacter::Move);
...
void AFeaturesCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AFeaturesCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
